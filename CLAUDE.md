...
- Real-auth coach/client verification: **complete with documented blocked/not-applicable cases** in `docs/hardening/phase-3-4-flow-verification.md`. The only credential-gated application path left is AI-assisted PDF import; Stripe live activation and My PT Hub migration remain outside this goal.
