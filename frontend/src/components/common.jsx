...
// recharts lives in its own chunk — common.jsx is imported by nearly every
// page, and a static chart import would drag the library into the entry
// bundle for Login and all non-chart screens.
const LazyMetricChart = lazy(() => import('./MetricChart'));
...
/* ---------- Metric chart (lazy recharts wrapper) ---------- */

export function MetricChart(props) {
  return (
    <Suspense fallback={<div className="h-[220px] animate-pulse rounded-lg bg-muted/40" aria-hidden />}>
